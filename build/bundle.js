...
/***/ function(module, exports, __webpack_require__) {
	...
	var LuSlide = function (_Component) {
	    _inherits(LuSlide, _Component);
	
	    function LuSlide() {
	        _classCallCheck(this, LuSlide);
	
	        var _this = _possibleConstructorReturn(this, (LuSlide.__proto__ || Object.getPrototypeOf(LuSlide)).call(this));
	
	        _this.state = {
	            activeIndex: 0
	        };
	
	        _this.handleLeftButton = _this.handleLeftButton.bind(_this);
	        _this.handleRightButton = _this.handleRightButton.bind(_this);
	        return _this;
	    }
	
	    _createClass(LuSlide, [{
	        key: 'handleLeftButton',
	        value: function handleLeftButton() {
	            var slideData = this.props.slideData;
	
	
	            var newActiveIndex = this.state.activeIndex - 1 >= 0 ? this.state.activeIndex - 1 : slideData.length - 1;
	        ...
	        value: function handleRightButton() {
	            ...
	            var newActiveIndex = this.state.activeIndex + 1 <= slideData.length - 1 ? this.state.activeIndex + 1 : 0;
	        ...
	        key: 'handleClickDot',
	        value: function handleClickDot(index) {
	            this.setState({
	                activeIndex: index
	            });
	        }
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'slide-button-wrapper' },
	                    _react2.default.createElement('div', { className: 'slide-left-button',
	                        onClick: this.handleLeftButton }),
	                    _react2.default.createElement('div', { className: 'slide-right-button',
	                        onClick: this.handleRightButton })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'slide-dots-wrapper' },
	                    this.renderDots()
	                )
	            );
	        }
	    }, {
	        key: 'getSlideItemClassName',
	        value: function getSlideItemClassName(index) {
	        ...
	        key: 'renderSlideItems',
	        value: function renderSlideItems() {
	            var _this2 = this;
	
	            var slideData = this.props.slideData;
	
	
	            return slideData.map(function (item, index) {
	                return _react2.default.createElement(
	                    'li',
	                    { className: _this2.getSlideItemClassName(index), key: index },
	                    _react2.default.createElement(
	                        'a',
	                        { href: item.clickLink, target: '_blank', title: item.title },
	                        _react2.default.createElement('img', { src: item.imgLink, alt: '图片' })
	                    )
	                );
	            });
	        }
	    }, {
	        key: 'getSlideDotClassName',
	        value: function getSlideDotClassName(index) {
	            return (0, _classnames2.default)({
	                'slide-dot': true,
	                'active': this.state.activeIndex === index
	            });
	        ...
	        value: function renderDots() {
	            ...
	            return slideData.map(function (item, index) {
	                return _react2.default.createElement(
	                    'li',
	                    { className: _this3.getSlideDotClassName(index),
	                        onClick: _this3.handleClickDot.bind(_this3, index),
	                        key: index },
	                    '•'
	                );
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(
	    ...
	    _react2.default.createElement(_index2.default, { slideData: slideData })
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body {\n  margin: 0; }\n\nli {\n  list-style-type: none; }\n\n.lu-slide {\n  position: relative;\n  width: 100%;\n  height: 100%;\n  z-index: 1; }\n  .lu-slide .slide-items-wrapper {\n    width: 100%;\n    height: 100%; }\n    .lu-slide .slide-items-wrapper .slide-item {\n      width: 100%;\n      height: 100%;\n      position: absolute;\n      width: 100%;\n      opacity: 0; }\n      .lu-slide .slide-items-wrapper .slide-item a img {\n        width: 100%;\n        height: 100%; }\n    .lu-slide .slide-items-wrapper .slide-item.active {\n      animation-duration: 0.2s;\n      animation-name: active;\n      animation-timing-function: ease;\n      animation-fill-mode: forwards; }\n\n@keyframes active {\n  from {\n    opacity: 0; }\n  to {\n    opacity: 1; } }\n  .lu-slide .slide-button-wrapper .slide-left-button, .lu-slide .slide-button-wrapper .slide-right-button {\n    width: 30px;\n    height: 60px;\n    position: absolute;\n    top: 50%;\n    margin-top: -30px;\n    background-size: contain;\n    z-index: 10;\n    opacity: 0.3; }\n    .lu-slide .slide-button-wrapper .slide-left-button:hover, .lu-slide .slide-button-wrapper .slide-right-button:hover {\n      opacity: 0.4;\n      cursor: pointer; }\n  .lu-slide .slide-button-wrapper .slide-left-button {\n    left: 0px;\n    background-image: url(http://7xkpdt.com1.z0.glb.clouddn.com/fe81815a1489655dc2fea452ef425704.png); }\n  .lu-slide .slide-button-wrapper .slide-right-button {\n    right: 0px;\n    background-image: url(http://7xkpdt.com1.z0.glb.clouddn.com/76c76cad02e65e6ebff83744df89604f.png); }\n  .lu-slide .slide-dots-wrapper {\n    position: absolute;\n    bottom: 4px;\n    width: 100%;\n    height: 26px;\n    text-align: center; }\n    .lu-slide .slide-dots-wrapper .slide-dot {\n      display: inline-block;\n      width: 26px;\n      height: 26px;\n      line-height: 26px;\n      font-size: 26px;\n      color: #8c8c8c;\n      background: 0 0;\n      border-radius: 0;\n      box-shadow: none;\n      text-indent: 0;\n      cursor: pointer; }\n    .lu-slide .slide-dots-wrapper .slide-dot.active {\n      color: #e6551d; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".slide-wrapper {\n  width: 680px;\n  height: 360px; }\n", ""]);
